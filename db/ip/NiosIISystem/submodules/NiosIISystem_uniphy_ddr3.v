...
`timescale 1 ps / 1 ps
module NiosIISystem_uniphy_ddr3 (
	...
	NiosIISystem_uniphy_ddr3_pll0 pll0 (
	...
	NiosIISystem_uniphy_ddr3_p0 p0 (
		.global_reset_n              (global_reset_n),                              //        global_reset.reset_n
	...
	NiosIISystem_uniphy_ddr3_s0 s0 (
		.avl_clk                     (p0_avl_clk_clk),                               //          avl_clk.clk
		.avl_reset_n                 (p0_avl_reset_reset),                           //        avl_reset.reset_n
		.scc_clk                     (p0_scc_clk_clk),                               //          scc_clk.clk
	...
	NiosIISystem_uniphy_ddr3_dmaster #(
		.USE_PLI     (0),
		.PLI_PORT    (50000),
		.FIFO_DEPTHS (2)
	) dmaster (
	...
	NiosIISystem_uniphy_ddr3_c0 c0 (
		.afi_reset_n         (afi_reset_n),                //    afi_reset.reset_n
		.afi_clk             (afi_clk),                    //      afi_clk.clk
		.afi_half_clk        (afi_half_clk),               // afi_half_clk.clk
	...
	NiosIISystem_uniphy_ddr3_mm_interconnect_0 mm_interconnect_0 (
