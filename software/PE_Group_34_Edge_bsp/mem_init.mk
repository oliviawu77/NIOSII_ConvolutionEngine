...
# Memory: dma_read_memory
MEM_0 := NiosIISystem_dma_read_memory
$(MEM_0)_NAME := dma_read_memory
...
$(MEM_0)_START := 0x04101000
$(MEM_0)_END := 0x04101fff
$(MEM_0)_SPAN := 0x00001000
$(MEM_0)_HIERARCHICAL_PATH := dma_read_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: dma_read_memory
dma_read_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_memory
MEM_1 := NiosIISystem_onchip_memory
...
$(MEM_2)_HIERARCHICAL_PATH := uniphy_ddr3
$(MEM_2)_WIDTH := 32
